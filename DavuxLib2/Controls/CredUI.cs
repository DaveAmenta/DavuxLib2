...
namespace DavuxLib2.Controls
{
    class WinHelper : IWin32Window
    {
    ...
    public sealed class CredentialsDialog
    {
        ...
        public DialogResult Show(IntPtr Handle)
        {
            return Show(new WinHelper { Handle = Handle }, this.Name, this.Password, this.SaveChecked);
        }
